...
const { create, list, getLink, results, generateTeamLetters, sendTeamFeedback, summarizeSubmission, resend, revoke, getInsights, generateInsights } = require('../controllers/evaluationLink.controller');
